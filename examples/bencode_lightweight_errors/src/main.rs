...
use bencode_lib::{BencodeError, parse_bytes};
...
fn main() {
            ...
            Err(e) => {
                ...
                match err {
                    ...
                    BencodeError::UnterminatedInteger => 
                        println!("   {}: No 'e' terminator (code={})", description, err.code()),
                    BencodeError::InvalidStringLength => 
                        println!("   {}: String length issue (code={})", description, err.code()),
    ...
    println!("   BencodeError size: {} bytes", core::mem::size_of::<BencodeError>());
    println!("   String error size: {} bytes", core::mem::size_of::<String>());
    println!("   Result<(), BencodeError> size: {} bytes", 
...
fn simulate_embedded_error_reporting() {
    ...
    println!("   Error log: {:?} ({} errors)", 
             &error_log[..error_count], error_count);
}
